...
const runAnalyzeVerse = async (requestData, geminiApiKeySecret) => {
            ...
            try {
                ...
                if (error.status === 429 || error.status === 503 || errorStr.includes("429") || errorStr.includes("503")) {
                    if (attempts >= maxAttempts) {
                        ...
                        throw new https_1.HttpsError("resource-exhausted", `Servidor saturado. Por favor, intenta de nuevo en unos minutos.`);
                    }
                    ...
                    throw new https_1.HttpsError("internal", "Hubo un error interno procesando el texto con Gemini.");
                }
            }
        }
        if (!resultText) {
...
exports.analyzeVerse = (0, https_1.onCall)({ cors: true, timeoutSeconds: 540, memory: "1GiB" }, async (request) => {
    return await (0, exports.runAnalyzeVerse)(request.data, geminiApiKey.value());
});
